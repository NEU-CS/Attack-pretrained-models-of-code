...
class Recorder():
    def __init__(self, file_path: str) -> None:
        ...
        self.writer.writerow(["Index",
                        ...
                        "Extracted Names",
                        "Importance Score",
                        "Greedy No. Changed Names",
                        "Greedy No. Changed Tokens",
                        "Replaced Names",
                        "GA No. Changed Names",
                        "GA No. Changed Tokens",
                        "Attack Type",
                        "Query Times",
                        "Time Cost",
                        "Suc Type",
    ...
    def write(self, index, code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, score_info, nb_changed_var, nb_changed_pos, ganb_changed_var,ganb_changed_pos,replace_info, attack_type, query_times, time_cost,suctype,insertwords,orig_prob,curr_prob):
        self.writer.writerow([index,
                        code, 
                        prog_length, 
                        adv_code, 
