...
（DeepSeek和CodeLLaMA在训练时超参设置相同，训练过程一致，二者都是同一个架构。但DeepSeek的效果显著好于CodeLLaMA）（训练CodeLLaMA时出了问题？目前对比了代码，感觉没什么问题）  
...
本任务是代码翻译，将一段Java代码翻译为c-sharp代码。  
代码翻译中，首要任务是使得翻译后的代码语义上与源代码相同  
因此
