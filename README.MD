...
上表是CodeT5,CodeLLaMA,DeepSeek在生成式任务上的表现（CodeBert在生成式任务上表现太差，Performance很低,不对其做研究）  
beam search在生成式任务上的实现是未来的工作  


可以知道:  

    Performance: DeepSeek > CodeT5 >> CodeLLaMA

    Robustness: CodeLLaMA > CodeT5 > DeepSeek  
