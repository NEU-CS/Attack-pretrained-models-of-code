...
def main():
    ...
    for index, example in enumerate(eval_dataset):
        ...
        subs = substs[index]
        print("enter")
        code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, names_to_importance_score, nb_changed_var, nb_changed_pos, replaced_words,Suctype,insertwords,most_index,acc_nums = attacker.greedy_attack(code,true_label, subs,args.use_replace,args.use_insert)
