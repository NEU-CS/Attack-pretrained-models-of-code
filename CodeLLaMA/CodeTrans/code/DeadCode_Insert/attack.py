...
# @File    : attack.py
'''For attacking CodeLLaMA models on CodeTrans task with vllm'''
import sys
import os
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="../finetune/CodeLlama7bForCodeTransLoRA/checkpoint-6435", type=str,
                        help="The model checkpoint for weights initialization.")
    parser.add_argument("--tokenizer_name", default="../finetune/CodeLlama7bForCodeTransLoRA/checkpoint-6435", type=str,
                        help="The model checkpoint for weights initialization.")
    ...
    lorarequest = LoRARequest("CodeLLaMA7bForCodeTrans",1,args.model_name_or_path)
