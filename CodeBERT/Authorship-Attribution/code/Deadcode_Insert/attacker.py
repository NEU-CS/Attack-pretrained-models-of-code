...
class Attacker():
    ...
    def greedy_attack(self, code,true_label,subs,ifreplace,ifinsert):
            ...
            if transf == "replace":
                ...
                for i,v in enumerate(temp_results):
                    if v['label'] != true_label:
                        ...
                        return code,prog_length,temp_inputs[i],true_label,orig_label,v['label'],1,variable_names,importance_score, nb_changed_var, nb_changed_pos, replaced_words,"replace",insert_words
                ...
                if(len(ids) >= 2):
                    ...
                    for onedeadcode in deadcodes:
                        ...
                        if label != true_label:
                            ...
                            return code,prog_length,"".join(code_lst[insert_pos:] + [onedeadcode] + code_lst[:insert_pos]),true_label,orig_label,label,1,variable_names,importance_score, nb_changed_var, nb_changed_pos, replaced_words,"insert",insert_words
                        else:
        ...
        return code, prog_length, final_code, true_label, orig_label, temp_label, is_success, variable_names, importance_score, nb_changed_var, nb_changed_pos, replaced_words,"failed",insert_words
