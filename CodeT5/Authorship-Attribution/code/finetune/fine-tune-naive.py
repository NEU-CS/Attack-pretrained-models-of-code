...
tokenizer.save_pretrained("CodeT5ForAA")

model = AutoModelForSequenceClassification.from_pretrained(model_name,num_labels = 66)
train_batch_size = 8
eval_batch_size = 32
lr = 5e-5
num_epochs = 20
...
for epoch in range(num_epochs):
    ...
    if eval_acc > max_eval_acc:
        ...
        model.save_pretrained("CodeT5ForAA")
