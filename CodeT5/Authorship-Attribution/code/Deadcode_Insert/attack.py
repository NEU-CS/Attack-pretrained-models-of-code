...
from transformers import RobertaTokenizer, RobertaForSequenceClassification,pipeline,RobertaForMaskedLM,AutoTokenizer,AutoModelForSequenceClassification
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default="../finetune/CodeT5ForAA", type=str,
                        help="The model checkpoint for weights initialization.")
    parser.add_argument("--tokenizer_name", default="../finetune/CodeT5ForAA", type=str,
                        help="The model checkpoint for weights initialization.")
    ...
    model = AutoModelForSequenceClassification.from_pretrained(args.model_name_or_path, num_labels = 66)  
    ...
    for index, example in enumerate(eval_dataset):
        ...
        recoder.write(index, code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, score_info, nb_changed_var, nb_changed_pos,ganb_changed_var,ganb_changed_pos,replace_info, attack_type, classifier.query() - query_times, example_end_time,Suctype,insertwords,original_prob,current_prob)
