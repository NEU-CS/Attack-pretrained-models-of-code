...
class Attacker():
    ...
    def greedy_attack(self, code,true_label,subs,ifreplace,ifinsert):
            ...
            for name_and_score in sorted_list_of_names:
                ...
                for index, oneresult in enumerate(temp_results):
                    ...
                    if temp_label != orig_label:
                        ...
                        return code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, importance_score, nb_changed_var, nb_changed_pos, replaced_words,"replace",[]
                    else:
        ...
        if ifinsert:
            ...
            for addcode in vocab:
                ...
                if temp_result[0]['label'] != true_label:
                    ...
                    is_success = 1
                    return code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, importance_score, nb_changed_var, nb_changed_pos, replaced_words,"insert",insert_words
                else:
        ...
        return code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, importance_score, nb_changed_var, nb_changed_pos, replaced_words,"failed",insert_words
