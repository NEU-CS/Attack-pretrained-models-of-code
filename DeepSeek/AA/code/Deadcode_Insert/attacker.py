...
class Attacker():
    ...
    def greedy_attack(self, code,true_label,subs,ifreplace,ifinsert):
        ...
        if not orig_label == true_label:
            # 说明原来就是错的
            is_success = -4
            return code, prog_length, adv_code, true_label, orig_label, temp_label, is_success, variable_names, None, None, None, None,None,None,0,0,orig_prob,current_prob
        ...
        if importance_score is None:
            return code, prog_length, adv_code, true_label, orig_label, temp_label, -3, variable_names, None, None, None, None,None,None,0,0,orig_prob,current_prob
            ...
            if transf == "replace":
                ...
                for i,v in enumerate(temp_results):
                    if v['label'] != true_label:
                        ...
                        return code,prog_length,temp_inputs[i],true_label,orig_label,v['label'],1,variable_names,importance_score, nb_changed_var, nb_changed_pos, replaced_words,"replace",insert_words,0,0,orig_prob,current_prob
                ...
                if(len(ids) >= 1):
                    ...
                    for onedeadcode in deadcodes:
                        ...
                        if label != true_label:
                            ...
                            return code,prog_length,"".join(code_lst[insert_pos:] + [onedeadcode] + code_lst[:insert_pos]),true_label,orig_label,label,1,variable_names,importance_score, nb_changed_var, nb_changed_pos, replaced_words,"insert",insert_words,0,0,orig_prob,current_prob
                        else:
        ...
        return code, prog_length, final_code, true_label, orig_label, temp_label, is_success, variable_names, importance_score, nb_changed_var, nb_changed_pos, replaced_words,"failed",insert_words,0,0,orig_prob,current_prob
